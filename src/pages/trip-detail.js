 ...
 let element = <Prints />;
  ...
  return (
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24" fill="none">
      <path d="M12 2C8.13401 2 5 5.13401 5 9C5 14.25 12 21 12 21C12 21 19 14.25 19 9C19 5.13401 15.866 2 12 2ZM12 11.5C10.6193 11.5 9.5 10.3807 9.5 9C9.5 7.61929 10.6193 6.5 12 6.5C13.3807 6.5 14.5 7.61929 14.5 9C14.5 10.3807 13.3807 11.5 12 11.5Z" fill="black"/>
    </svg>
      {staticData?.data?.address}: 
      {bookingData?.data?.order?.address || 'N/A'}, 
      {bookingData?.data?.order?.city || 'N/A'}, 
      {bookingData?.data?.order?.country || 'N/A'}
                      ...
                      {bookingData?.data?.driver?.email || 'N/A'}, 
                      {/* {rep_email}  */}
                      </li>
                    ...
                    {bookingData?.data?.driver?.phone || 'N/A'}, 
                    {/* {rep_telephone}  */}
                    </li>
                  ...
                  <p>Equipment: {bookingData?.data?.order?.eurocar_equipment_code  || 'N/A'}</p>
                  <p>Insurance: {bookingData?.data?.order?.eurocar_insurance_code  || 'N/A'}</p>
                  <p>{extra}</p>
